    ...
    try {
        ...
        const sidebarHTML = `
            ...
            <nav class="flex-grow">
                ...
                <a href="vehicle-database.html" class="sidebar-link ${activePage === 'vehicle-database' ? 'active bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-700'} flex items-center mt-2 px-4 py-3 rounded-lg"><i data-lucide="car" class="w-5 h-5 mr-3"></i> Baza Pojazdów</a>
                ...
                <a href="stroje.html" class="sidebar-link ${activePage === 'stroje' ? 'active bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-700'} flex items-center mt-2 px-4 py-3 rounded-lg"><i data-lucide="shirt" class="w-5 h-5 mr-3"></i> Stroje WSP</a>
                <a href="urlopy.html" class="sidebar-link ${activePage === 'urlopy' ? 'active bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-700'} flex items-center mt-2 px-4 py-3 rounded-lg"><i data-lucide="calendar-off" class="w-5 h-5 mr-3"></i> Urlopy</a>
